...
export default function Sidebar({ activeView, setActiveView, onLogout, onNewTask, onSupport, user, selectedTeamId, setSelectedTeamId }: SidebarProps) {
    ...
    return (
        <aside className={`${isCollapsed ? 'w-20' : 'w-64'} transition-all duration-300 flex flex-col flex-shrink-0 bg-surface border-r border-border sticky top-0 h-screen overflow-hidden`}>
            {/* Header */}
